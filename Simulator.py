...
class Simulator():
    ...
    def pass_to_network_layer(self, entity, packet, is_ACK = False):
        self.ntolayer3 += 1
        ...
        self.print_entity_message(entity, "Passing to the Network Layer", packet)
    ...
    def pass_to_application_layer(self, entity, data):
        ...
        self.print_entity_message(entity, "Passing to application: %s" % data, None)
